...
internal class StandardShaderGUI : ShaderGUI
{
	...
	public static void SetupMaterialWithCullMode(Material material, CullMode cullMode)
	{
		switch (cullMode)
		{
			case CullMode.OneSided:
				material.DisableKeyword("_INVERT_NORMAL");
				material.DisableKeyword("_TWO_SIDED");			
				break;
			case CullMode.Reversed:
				material.EnableKeyword("_INVERT_NORMAL");
				material.DisableKeyword("_TWO_SIDED");			
				break;
			case CullMode.TwoSided:
				material.DisableKeyword("_INVERT_NORMAL");
				material.EnableKeyword("_TWO_SIDED");	
				break;
		}
	}
